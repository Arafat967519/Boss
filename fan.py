...
try:
    ...
    print('\n \033[1;91m[\033[1;93m🔥𝗔𝗥𝗔𝗙𝗔𝗧 𝗫 𝗦𝗔𝗠𝗜𝗨𝗟🔥\033[1;91m]\033[1;97m installing requests !...\n')
    os.system("espeak -a 300 \"Assalamu Alikum,  Brother,   This, is, Arafat, X, Samiul, Paid,Tool, please,Wait, For, Installing\"")
...
try:
    ...
    print('\n \033[1;91m[\033[1;93m🔥𝗔𝗥𝗔𝗙𝗔𝗧 𝗫 𝗦𝗔𝗠𝗜𝗨𝗟🔥\033[1;91m]\033[1;97m installing futures !...\n')
    time.sleep(0.5)
    os.system('pip install futures')
try:
    import bs4
except ImportError:
    print('\n \033[1;91m[\033[1;93m🔥𝗔𝗥𝗔𝗙𝗔𝗧 𝗫 𝗦𝗔𝗠𝗜𝗨𝗟🔥\033[1;91m]\033[1;97m installing bs4 !...\n')
    time.sleep(0.5)
...
time.sleep(2)
#os.system('clear')
print('\033[91;1m[\x1b[31;5;50m+\033[91;1m] \x1b[31;5;50mUPDATE VERSHON 🔥1.1🔥 ')
os.system("espeak -a 300 \"UPDATE VERSION 1.1,\"")
time.sleep(2)
#os.system('clear')
print("\033[95;1m[\x1b[35;5;50m+\033[97;1m]\x1b[35;5;50m MY FACEBOOK ID ..!")
os.system("espeak -a 300 \"FOLLOW MY FACEBOOK ID ,\"")
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/profile.php?id=100028777883146')
os.system(f'xdg-open https://www.facebook.com/profile.php?id=100028777883146')
import os
import sys
import time
...
try:
    os.system('clear')
    srv=requests.get('https://raw.githubusercontent.com/SEFAT-ABUSAIM/SPIDER/main/srv.txt').text 
    if "update" in srv:
        os.system('clear')
        for j in range(3000):
            time.sleep(0.5)
...
os.system('espeak -a 300 " Welcome,   to,  Arafat, X, Samiul,  PAID,   Tools"')
def back():
	login()
...
while attemps < 12345677901:
    ...
    if username == 'Arafat' and password == 'Samiul':
        print(' \033[0;95mYou Have Successfully Logged in.')
        os.system('espeak -a 300 " Successfully,   Log,  In,  Sir"')
        break
    else:
        print(' Incorrect Password Please Trying ')
        os.system("espeak -a 300 \"Incorrect, Password, Please, Try, Again  \"")
        os.system("espeak -a 300 \" If, you, want, to, know, the, username, and, password, please, contact, Arafat, Rahman\"")
        attemps += 1
        continue
def mahadi():
    os.system('clear')
    os.system("espeak -a 300 \"Select, Options\"")
...
def ___uids___():
    ...
    os.system("espeak -a 300 \"Enter, Cracking,Limit \"")
    os.system(f'xdg-open https://www.facebook.com/profile.php?id=100028777883146')  
    ...
    with tred(max_workers=30) as SefatMahadi:
        os.system('clear')
        os.system("espeak -a 300 \"Cracking, Started, Please, Wait, For, Okay, ID\"")
        os.system("espeak -a 300 \"If, you, no, results, found, turn, on, off, airplane, mode \"")
        logo()
        tl = str(len(user))
